...
class Fish: UIView {
    ...
    init(origin: CGPoint, isAnglefish: Bool, inFront: Bool, facingLeft: Bool,
        ...
        // Set anchor points and offsets. Finetune the fish body and tail alignment here.
        if isAnglefish {
            ...
            tail!.center.y += 1.5
            tail!.center.x += tail!.frame.width / 4 + tail!.frame.width + 2
        } else {
    ...
    // MARK: Methods to adapt to lighting condition
    func lightOn() {
